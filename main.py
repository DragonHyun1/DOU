...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        # 앱 시작 시: HVPM/ADB 포트 확인 + HVPM 연결돼 있으면 전압 1회 자동 읽기
    ...
    def _initial_probe(self):
        ...
        # 여기서만 전압 자동 읽기 수행 (HVPM connected일 때)
    ...
    def on_refresh_clicked(self):
        ...
        try:
            ...
            pass
        # 여기서는 volt read 호출하지 않음 (요청사항 반영)
