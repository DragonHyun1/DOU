...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        # === ADD-ONLY: Refresh 시 전압 읽기 여부 스위치(기본 False → 읽지 않음)
    ...
    def _initial_probe(self):
        ...
        # HVPM이 이미 연결돼 있으면 1회 전압 자동 읽기(기존 핸들러 재사용)
    ...
    def on_refresh_clicked(self):
        ...
        # 필요 시 과거 동작(Refresh 시 전압도 읽기) 복구용 스위치
    ...
    def start_graph(self):
        ...
        self._on_graph_tick()              # 첫 포인트 즉시 갱신(빈 화면 방지)
